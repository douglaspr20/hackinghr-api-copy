...
module.exports = (sequelize, DataTypes) => {
  class SkillCohortResourceResponse extends Model {
    ...
    static associate(models) {
      ...
      SkillCohortResourceResponse.belongsTo(models.SkillCohortResources, { foreignKey: 'SkillCohortResourceId' })
      SkillCohortResourceResponse.belongsTo(models.SkillCohortParticipant, { foreignKey: 'SkillCohortParticipantId' })
